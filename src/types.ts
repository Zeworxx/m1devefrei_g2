...
import { TrackModel, AuthorModel, GhibliFilmModel, GhibliPeopleModel } from './models';
...
export type ResolversTypes = {
  ...
  Film: ResolverTypeWrapper<GhibliFilmModel>;
  Float: ResolverTypeWrapper<Scalars['Float']['output']>;
  ID: ResolverTypeWrapper<Scalars['ID']['output']>;
  Int: ResolverTypeWrapper<Scalars['Int']['output']>;
  People: ResolverTypeWrapper<GhibliPeopleModel>;
